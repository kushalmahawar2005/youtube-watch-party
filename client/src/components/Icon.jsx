...
const PATHS = {
  ...
  share: (
    <>
      ...
      <path d="M5 12.5v5a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5" />
    </>
  ),
  leave: (
    <>
  ...
  settings: (
    <>
      ...
      <path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.28 2.28-.06-.06a1.7 1.7 0 0 0-1.88-.34 1.7 1.7 0 0 0-1.04 1.56V20.5h-3.2v-.12A1.7 1.7 0 0 0 10.3 18.8a1.7 1.7 0 0 0-1.88.34l-.06.06-2.28-2.28.06-.06A1.7 1.7 0 0 0 6.48 15a1.7 1.7 0 0 0-1.56-1.04H4.8v-3.2h.12a1.7 1.7 0 0 0 1.56-1.04 1.7 1.7 0 0 0-.34-1.88l-.06-.06 2.28-2.28.06.06a1.7 1.7 0 0 0 1.88.34 1.7 1.7 0 0 0 1.04-1.56V4.2h3.2v.12a1.7 1.7 0 0 0 1.04 1.56 1.7 1.7 0 0 0 1.88-.34l.06-.06 2.28 2.28-.06.06a1.7 1.7 0 0 0-.34 1.88 1.7 1.7 0 0 0 1.56 1.04h.12v3.2h-.12A1.7 1.7 0 0 0 19.4 15Z" />
    </>
  ),
};
